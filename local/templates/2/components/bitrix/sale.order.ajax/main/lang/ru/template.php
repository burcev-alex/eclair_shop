...
$MESS["SOA_ORDER_SUC1"] = "Персональный менеджер Eclair Cafe свяжется с Вами для подтверждения заказа в течение 15 минут.";
$MESS["SOA_PAY"] = "Оплата заказа";
$MESS["SOA_PAY_LINK"] = "Если окно с платежной информацией не открылось автоматически, нажмите на ссылку <a class='linktopayorder' href=\"#LINK#\" target=\"_blank\">Оплатить заказ</a>.";
...
$MESS["REGION_BLOCK_NAME_DEFAULT"] = "Адрес доставки";
