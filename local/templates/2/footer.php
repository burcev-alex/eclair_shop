            ...
            <div class="col-sm-4">
                <div class="col-wrapper">
                    ...
                    <div class="descr" style="color:#ffffff;font-size:14px;" field="descr">
                        <a href="tel:+73833833346" style="" class="roistatphone">+7 383 383-33-46</a><br>cofferoom@mail.ru<br></div>
                </div>
            </div>
            <div class="col-sm-4 ">
...
<div id="rec177056195" class="container-fluid footer-3" style=" "  >
            <div class="row">
                <div class="col-sm-2">
                    <div class="t452__typo t452__copyright t-name t-name_xs"  style="color: #ffffff;"> © 2013 ECLAIR cafe </div>
                </div>
                <div class="col-sm-8">
                ...
                <div class="col-sm-2">
                    <div class="t452__scroll t-align_right">
                        <a class="t452__typo t-name t-name_xs t452_scrolltop" style="color: #ffffff;" href="javascript:t452_scrollToTop();"> Вверх
