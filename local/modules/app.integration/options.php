...
$arAllOptions =
	array(
		...
		array("crm_url", "crm_url", "", array("text", 10)),
		array("crm_host", "crm_host", "", array("text", 10)),
		array("crm_token", "crm_token", "", array("text", 10)),
		array("crm_format", "crm_format", "", array("text", 10)),
	);
...
?>
	...
	<tr>
		<td valign="top" width="20%">
			Веб-сервис (URL):
		<td valign="top" width="80%">
			<input type="text" size="60" value="<?=COption::GetOptionString("app.integration", "crm_url");?>" name="crm_url">
		</td>
	</tr>
	<tr>
		<td valign="top" width="20%">
			Веб-сервис (HOST):
		<td valign="top" width="80%">
			<input type="text" size="60" value="<?=COption::GetOptionString("app.integration", "crm_host");?>" name="crm_host">
		</td>
	</tr>
	<tr>
		<td valign="top" width="20%">
			Веб-сервис (TOKEN):
		<td valign="top" width="80%">
			<input type="text" size="60" value="<?=COption::GetOptionString("app.integration", "crm_token");?>" name="crm_token">
		</td>
	</tr>
	<tr>
		<td valign="top" width="20%">
			Веб-сервис (FORMAT):
		<td valign="top" width="80%">
			<input type="text" size="60" value="<?=COption::GetOptionString("app.integration", "crm_format");?>" name="crm_format">
		</td>
	</tr>
	<?$tabControl->BeginNextTab();?>
        <?require_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/main/admin/group_rights.php");?>
